...
function botIdentifyFormatter(logEntry) {
    if (process.env.BOT_IDENTIFIER)
        logEntry["bot-identifier"] = process.env.BOT_IDENTIFIER;
    return logEntry;
}
const Logger = winston.createLogger({
    level: "debug",
    format: winston.format.combine(winston.format(botIdentifyFormatter)(), winston.format(logEntry => logEntry)(), winston.format(errorStackTracerFormatter)(), winston.format.json()),
    transports,
