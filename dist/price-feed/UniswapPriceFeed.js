...
const MAX_SAFE_JS_INT = 2147483647;
class UniswapPriceFeed extends PriceFeedInterface {
    ...
    update() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const events = yield this.uniswap.getPastEvents("Sync", { fromBlock: 0 });
            ...
            while (i !== 0) {
                ...
                event.timestamp = (yield this.web3.eth.getBlock(event.blockNumber)).timestamp;
    ...
    _getPriceFromSyncEvent(event) {
        ...
        if (reserve1.isZero() || reserve0.isZero())
            return null;
        if (this.invertPrice) {
...
//# sourceMappingURL=UniswapPriceFeed.js.map